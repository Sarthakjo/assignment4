	...
	*/	
    ...
    public void testBug1() {
        ...
        List<DiceValue> cdv = game.getDiceValues();
   		...
   		String playerName = "Sarthak";
        int currentBalance = 100;
        int limit = 0;
        Player player = new Player(playerName, currentBalance);
		...
		if (winnings > 0) {
			System.out.printf("%s won %d, currentBalance now %d\n\n", player.getName(), winnings, player.getBalance());			
		}
		else {
			System.out.printf("%s lost, currentBalance now %d\n", player.getName(), player.getBalance());
		}
	...
	/*
	Unit test for  Bug 2, Player cannot reach betting limit, game ends with $5 currentBalance 
	*/
	@Test
    public void testBug2() {
		
		String playerName = "Saugat";
		...
		System.out.println(String.format("%s now has currentBalance of $%d\n", player.getName(), player.getBalance()));
		System.out.printf("TEST BUG 2 ENDS\n\n"); 
	}//testBug2() 
	
	/*
	Unit test for  Bug 3, Player cannot reach betting limit, game ends with $5 currentBalance 
	*/
	@Test
    public void testBug3() throws Exception {
        ...
        while (true)
        {
			...
			{							
				...
				//System.out.printf("%s now has currentBalance of $%d\n", player.getName(), player.getBalance());
